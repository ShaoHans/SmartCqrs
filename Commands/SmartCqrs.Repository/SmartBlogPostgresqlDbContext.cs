...
{
    public class SmartBlogPostgresqlDbContext : DbContext
    {
        ...
        public SmartBlogPostgresqlDbContext(DbContextOptions<SmartBlogPostgresqlDbContext> options) : base(options)
        {
